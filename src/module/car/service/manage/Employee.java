...
public class Employee {
	...
	private void viewProfile(String user_id) {
		String empID = "", Emp_Name = "", Emp_address = "", Emp_email = "", Emp_Phone = "", Center_Name = "",
				Start_Date = "";
		int Role = 0, Salary = 0;
		try {
			...
			stmt = connection.prepareStatement(
					"SELECT E.EmpID, E.Emp_Name, E.Emp_address, E.Emp_email, E.Emp_Phone, S.Center_Name, E.Role, E.Emp_Start_Date, M.Salary FROM Employee E, Monthly_Paid_Emp M, WorksAt W, Service_Center S WHERE W.CenterID = S.CenterID AND E.EmpID = M.EmpID AND E.EmpID = ?");
			...
			stmt = connection.prepareStatement(
					"SELECT E.EmpID, E.Emp_Name, E.Emp_address, E.Emp_email, E.Emp_Phone, S.Center_Name, E.Role, E.Emp_Start_Date, M.WAGES FROM Employee E, mechanic_emp M, WorksAt W, Service_Center S WHERE W.CenterID = S.CenterID AND E.EmpID = M.EmpID AND E.EmpID = ?");
			stmt.setString(1, empID);
			rs = stmt.executeQuery();
