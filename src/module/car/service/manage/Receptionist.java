...
class Receptionist {
	...
	public void displayReceptionistLanding(String user_id) {
		...
		switch (user_choice) {
		case 1:
			employee.displayProfile(user_id);
			break;
		case 2:
	...
	/*
	 * public void serviceHistory(){ Scanner t= new Scanner(System.in);
	 * 
	 * System.out.println("Please enter the following details"); // run queries to
	 * add the following details into database
	 * System.out.print("A. Customer email address:\t"); String customer_email=
	 * t.next(); System.out.println("");
	 * 
	 * based on the customer_email, display the following:
	 * 
	 * service_id, license_plate, service_type, mechanic_name,
	 * service_start-date/time, service_end-date/time(expected or actual),
	 * service_status(Pending/Ongoing/Complete)
	 * 
	 * System.out.println("Go Back? Enter 1"); displayReceptionistLanding(UserId); }
	 * 
	 ...
	 * t.next(); System.out.println("");
	 * 
	 * System.out.print("B. License Plate:\t"); String license_plate= t.next();
	 * System.out.println("");
	 * 
	 * System.out.print("C. Current Mileage:\t"); String current_mileage= t.next();
	 * System.out.println("");
	 * 
	 * System.out.print("D. Mechanic Name(Optional):\t"); String mechanic_name=
	 * t.next(); System.out.println("");
	 * 
	 ...
	 * "\n" + "3. Go Back");
	 * 
	 * int user_choice= t.nextInt(); switch (user_choice) {
	 * 
	 * case 1: scheduleMaintenance(); break; case 2: scheduleRepair(); break; case
	 * 3: displayReceptionistLanding(UserId); break; default:
	 * System.out.println("Enter a valid choice");
	 * 
	 * } } public void scheduleMaintenance(){ Scanner t= new Scanner(System.in);
	 * 
	 * System.out.println("Please select one of the following");
	 * System.out.println("1. Find Service Date" + "\n" + " 2. Go Back");
	 * 
	 * int user_choice= t.nextInt(); switch (user_choice) { case 1:
	 * findServiceDate(); break; case 2: scheduleService(); break; default:
	 * System.out.println("Enter a valid choice"); break; } }
	 * 
	 * public void findServiceDate(){ Scanner t = new Scanner(System.in); //display
	 * the 2 earliest available dates from the db
	 * System.out.println("Please select one of the following");
	 * System.out.println("1. Schedule on Date" + "\n" + " 2. Go Back");
	 * 
	 * int user_choice= t.nextInt(); switch (user_choice) {
	 * 
	 * case 1: System.out.println("Service appointment successfully saved");
	 * scheduleService(); break; case 2: scheduleMaintenance(); break; default:
	 * System.out.println("Enter a valid choice"); break; } }
	 * 
	 * public void scheduleRepair(){ Scanner t= new Scanner(System.in);
	 * 
	 ...
	 * 
	 * int user_choice= t.nextInt(); switch (user_choice) { //based on the repair
	 * display the report, 2 identifed service dates, mechanic_name case 1: case 2:
	 * case 3: case 4: case 5: case 6: case 7: case 8: scheduleService(); default:
	 * System.out.println("Enter a valid choice");
	 * 
	 * selectRepairDate(); } }
	 * 
	 * public void selectRepairDate(){ Scanner t= new Scanner(System.in);
	 * 
	 * System.out.println("Please select one of the following");
	 ...
	 * int user_choice= t.nextInt(); switch (user_choice) {
	 * 
	 * case 1: System.out.println("Repair appointment successfully saved");
	 * scheduleService();
	 * 
	 * case 2: scheduleRepair(); default:
	 * System.out.println("Enter a valid choice"); } }
	 * 
	 * public void rescheduleService(){ Scanner t= new Scanner(System.in);
	 * 
	 * System.out.
	 * println("Ask user to enter customer email-id and display the following: License Plate,"
	 * + "Service ID, Service Date, Service Type(Maintenance/Repair)," +
	 * "Service Details(Service A/B/C orProblem)");
	 * 
	 * System.out.print("Enter the email\t"); String customer_email= t.next();
	 * System.out.println("");
	 * 
	 * System.out.println("Please select one of the following");
	 ...
	 * 
	 * case 1: System.out.
	 * println("If the user chooses 1,ask him to enter one of the service IDs"
	 * +"to select the service to be rescheduled and then find two"
	 * +"earliest available maintenance/repair dates that are at least"
	 * +"one day after the current service date"); pickService();
	 * 
	 * case 2: displayReceptionistLanding(UserId); default:
	 * System.out.println("Enter a valid choice"); } }
	 * 
	 * public void pickService(){ Scanner t= new Scanner(System.in);
	 * 
	 ...
	 * 
	 * case 1: System.out.
	 * println("Ask the user to pick one fo the dates shown and add to db");
	 * displayReceptionistLanding(UserId);
	 * 
	 * case 2: displayReceptionistLanding(UserId); default:
	 * System.out.println("Enter a valid choice"); }
	 ...
	 * }
	 * 
	 * public void invoices(){ Scanner t= new Scanner(System.in);
	 * 
	 * System.out.
	 * println("Ask user to enter customer email-id and display the following: Service ID,"
	 ...
	 * System.out.println("1.Go Back"); int user_choice= t.nextInt(); if
	 * (user_choice == 1) displayReceptionistLanding(UserId); }
	 */
...
//    }
	...
	public void recordDeliverables() {
		...
		case 1:
			...
			// check status pending order id and - check center id_receiver of that order
			// from makes table
			...
			try {
				...
				for (String pending_order : pending_order_ids) {
					...
					if (part_arrived == 1) {
						...
						stmt = connection
								.prepareStatement("SELECT Part_ID, car_make FROM OrderPart WHERE CenterID = ?");
						...
						stmt = connection.prepareStatement(
								"SELECT quantity FROM OrderPart WHERE CenterID = ? AND Part_ID = ? AND car_make = ?");
						stmt.setString(1, receiver_center_id);
						...
						stmt = connection.prepareStatement(
								"SELECT Current_quantity FROM Inventory WHERE CenterID = ? AND PartID = ? AND Car_model = ?");
						stmt.setString(1, receiver_center_id);
						stmt.setString(2, part_id);
						stmt.setString(3, car_model);
						rs = stmt.executeQuery();
						...
						stmt = connection.prepareStatement(
								"UPDATE OrderPart SET Status = 'Complete' , Actual_date = ? WHERE CenterID = ? AND Part_ID = ? AND car_make = ?");
